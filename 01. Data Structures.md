...
### LinkedList or Array?
1. Every operation in LinkedList always take constant time in the worst case, while in arrary it takes amortized time. Use LinkedList if EVERY operation has to be fast.  Use array for better total amout of time, as individual operation is faster.  
2. LinkedList uses extra time and space.  
